...
# ── Built-in effects ─────────────────────────────────────────────────────
# Sourced from captures/oem-app-dump/Dev/kb/wired/KB.ini (LedOpt entries).
# UI index → name, whether the effect has speed / color modulation.
# Effect 21 is exposed separately via the `perkey` command (self-define).
EFFECTS = {
